...
public class MainPageObject {
    ...
    public WebElement assertElementContainsText(By by, String expected_text, String error_message){
        WebElement element = waitForElementPresent(by, "Element " + by + " not found");
        String actual_text = element.getText();
    ...
    public List<WebElement> assertElementsContainText(By by, String expected_text, String error_message){
    ...
    public List <WebElement> waitAndGetWebElements(By by, String error_message){
        waitForElementPresent(by, error_message, 5);
        return driver.findElements(by);
    }

    public void swipeUp(int tiemOfSwipe){
